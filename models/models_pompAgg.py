...
def modelV(x, beta, ihr, hfr, iVhr, hVfr, Vr, alpha, N, num_ensembles=200):
    ...
    eV2iVh     =  pomp_transition(EV,  iVhr*kappa, num_ensembles=num_ensembles)           # exposed to infected reported who are going to die
...
def init_modelV(pop, num_ensembles=300, num_variables=8, num_age_groups=16):
    ...
    for idx_ens in range(num_ensembles):
        ...
        IVr0  = 0
        IVu0  = 0
        S0   = S0-E0-Ir0-Iu0-SV0-EV0-IVr0-IVu0-Ih0-R0
